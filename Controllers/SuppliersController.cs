...
namespace doan1_v1.Controllers
{
	...
	public class SuppliersController : Controller
    {
        ...
        public SuppliersController(NTFashionDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,Phone,IsDel")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phone,IsDel")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
